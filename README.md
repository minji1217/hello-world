...
$$
\begin{aligned}
score\_1(p) = {} & \alpha \cdot \text{semantic\_score} \\
                 & + \beta\_1 \cdot \text{bib\_score} \\
                 & + \beta\_2 \cdot \text{graph\_score} \\
                 & + \beta\_3 \cdot \text{forward\_count} \\
                 & + \beta\_4 \cdot \text{backward\_count} \\
                 & + \beta\_5 \cdot \text{graph\_available}
\end{aligned}
$$
